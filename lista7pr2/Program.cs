        ...
        static void Main(string[] args)
        {
            ...
            switch (a)
            {
                case 1:
                    ...
                    Console.WriteLine("o valor total vai igual a:" + total);
                ...
                case 2:
                    ...
                    Console.WriteLine("o produto com maior investimento é: " + num + " com um investimento de R$" + vm + " e o de menor investimento é: " + nmm + " com um investimento de R$" + vmm);
